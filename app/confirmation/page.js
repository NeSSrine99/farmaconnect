...
//     // ✅ ثم توجه للصفحة التالية مثلاً:
//     router.push("/confirmation"); // أو أي صفحة تشكرية
//   };
...
//               <span>$8.00 - 1-2 days</span>
//             </label>
//             <label className="flex items-center gap-2 border px-4 py-2 rounded cursor-pointer">
//               <input type="radio" name="shipping" />
//               <span>$2.00 - 3-5 days</span>
//             </label>
//           </div>
//         </div>
...
//             />
//             <Input name="expiry" label="Date" placeholder="MM/YY" />
//             <Input name="cvv" label="CVV" placeholder="123" />
//           </div>
