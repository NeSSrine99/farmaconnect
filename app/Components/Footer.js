      ...
      <footer className="inline-flex flex-col items-start justify-start w-full gap-10 p-4 bg-gradient-to-b from-teal-50 via-teal-400 to-cyan-700">
        ...
        <div className="inline-flex flex-wrap items-start content-start self-stretch justify-between p-4 ">
          ...
          <div className="justify-end w-full max-w-[550px] min-w-64 inline-flex flex-col  items-start gap-10">
            <p>Moyens de Livraison </p>
            <div className="inline-flex flex-wrap items-center content-center self-stretch ">
        ...
        <div className="inline-flex flex-wrap items-start content-start self-stretch justify-center gap-5 wrap">
          <div  className="inline-flex flex-col items-start justify-start w-full gap-10 max-w-72 min-w-48">
            <p className="self-stretch justify-center text-xl font-semibold text-white">Nous contacter</p>
            <div>
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">7, bis rue Emile Blanc 38420 Domene 04 76 77 23 08</p>
            </div>
          </div>
          ...
          <div  className="inline-flex flex-col items-start justify-start w-full gap-10 max-w-72 min-w-48">
            <p className="self-stretch justify-center text-xl font-semibold text-white">Nous contacter</p>
            <div>
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">Qui sommes nous ?</p>
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">L'histoire de Pharmashopi
              Médicaments sur internet, quel avenir ?</p>
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">Parapharmacie en ligne</p>
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">Pharmacovigilance</p>
          ...
          <div  className="inline-flex flex-col items-start justify-start w-full gap-10 max-w-72 min-w-48">
            ...
            <div>
              <ul>
                <li className="self-stretch justify-start text-lg font-normal text-teal-950"><a>Paiement</a></li>
                <li className="self-stretch justify-start text-lg font-normal text-teal-950"><a>Expédition | Livraison</a></li>
                <li className="self-stretch justify-start text-lg font-normal text-teal-950"><a>Retour</a></li>
                <li className="self-stretch justify-start text-lg font-normal text-teal-950"><a>Foire aux questions</a></li>
                <li className="self-stretch justify-start text-lg font-normal text-teal-950"><a>Contact</a></li>
              </ul>
          ...
          <div  className="inline-flex flex-col items-start justify-start w-full gap-10 max-w-72 min-w-48">
            ...
            <div className="flex flex-col gap-4">
              <p className="self-stretch justify-start text-lg font-normal text-teal-950">Vous souhaitez rester informé(e) de nos dernières nouvelles et promotions ? Inscrivez-vous à notre newsletter.</p>
