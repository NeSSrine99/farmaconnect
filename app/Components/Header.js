  ...
  return (
    <nav className="flex items-center justify-between p-4 px-4 md:px-8 sm:px-16 relative">
      ...
      <a href="/" className="flex items-end">
        <img src="FarmaconnectLogo.svg" alt="logo" width={40} height={50} className="mb-2" />
      ...
      {menuOpen && (
        <div className="lg:hidden absolute top-[80px] right-2 p-2 py-4 flex bg-white flex-col items-start gap-2 rounded-b-xl shadow-defaultCard ">
          <Link href="/about" className="flex items-center gap-2 hover:underline text-neutral-400 text-lg font-normal ">
            <RiBloggerLine /> Blog
          </Link>
          <Link href="/about" className="flex items-center gap-2 hover:underline text-neutral-400 text-lg font-normal ">
            <TbPhoneCall /> Consultation
